...
Format: ```mngovernance prepare proposal-name url payment-count block-start bankitt-address monthly-payment-bankitt```
...
Format: ```mngovernance submit proposal-name url payment-count block-start bankitt-address monthly-payment-bankitt fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using bankitt.conf setup)
