...
Format: ```mngovernance prepare proposal-name url payment-count block-start bukake-address monthly-payment-bukake```
...
Format: ```mngovernance submit proposal-name url payment-count block-start bukake-address monthly-payment-bukake fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using bukake.conf setup)
