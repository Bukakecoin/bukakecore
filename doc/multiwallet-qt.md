...
Only requiring some minor changes is bukake.cpp.
...
Changes to bukake.cpp
----------------------
bukake.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
