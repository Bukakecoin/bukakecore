...
Only requiring some minor changes is bankitt.cpp.
...
Changes to bankitt.cpp
----------------------
bankitt.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
