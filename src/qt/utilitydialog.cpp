    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bankitt Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bankitt Core"));
...
All the Bankitt in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bankitt Core is shutting down...") + "<br /><br />" +
