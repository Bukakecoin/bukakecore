    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bukake Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bukake Core"));
...
All the Bukake in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bukake Core is shutting down...") + "<br /><br />" +
