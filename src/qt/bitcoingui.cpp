    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bankitt Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bankitt address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bankitt: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bankitt Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bankitt Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bankitt Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bankitt addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bankitt addresses"));
    ...
    openAction->setStatusTip(tr("Open a bankitt: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bankitt Core help message to get a list with possible Bankitt Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bankitt Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bankitt network", "", count));
    } else {
...
{
    QString strTitle = tr("Bankitt Core"); // default title
