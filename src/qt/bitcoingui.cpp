    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bukake Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bukake address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bukake Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bukake Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bukake Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bukake addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bukake addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bukake Core help message to get a list with possible Bukake Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bukake Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bukake network", "", count));
    } else {
...
{
    QString strTitle = tr("Bukake Core"); // default title
