...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000003300330"); // 50

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000001713fe688bee98928a1c6a306a668f14b81884c7915ba452e1c3b1c3d92"); // 50
        ...
        genesis = CreateGenesisBlock(1517296000, 857048, 0x1e0ffff0, 1, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("049858afb6266a8ec7ff056f7a089d7ccce4fa043b1e799eacf2aab4ef27c0146baefd7620df376fd7f9fa553e938ca42e493215c7ff79e443f633ac85cceceaaf");
        nDefaultPort = 1661;
        nMaxTipAge = 0x7fffffff; // allow mining on top of old blocks for testnet
        nDelayGetHeadersTime = 24 * 60 * 60;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1517296001, 2564551, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000097f1932426ccc0eb32e3a0e7db6bada6eeda92e985f1c75607e07060160"));
        assert(genesis.hashMerkleRoot == uint256S("0x67cc6063569bea507e4ed5b8eb4f33464234f4acd44b4e16f80088854139923c"));
        ...
        strSporkPubKey = "044738ae84daecbe1e083f9f019c0da6a7c8ccb26e6039c573593b137aa8dfa1ef5d5c7bb4de25e629e5b53542afc4eb8dd4f7f02502bfe9cea639e3df2bfca5e5";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000097f1932426ccc0eb32e3a0e7db6bada6eeda92e985f1c75607e07060160")),
            1517296001, // * UNIX timestamp of last checkpoint block
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1517296002, 3131213, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000fc505c994a49beeff8114b50947479bdd1e74605a2dcfa1e781f2e6d11f"));
        assert(genesis.hashMerkleRoot == uint256S("0x67cc6063569bea507e4ed5b8eb4f33464234f4acd44b4e16f80088854139923c"));
