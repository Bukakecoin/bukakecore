...
#define BOOST_TEST_MODULE Bankitt Test Suite

#include "test_bankitt.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bankitt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
